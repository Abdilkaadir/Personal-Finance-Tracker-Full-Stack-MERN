...
const LoginForm = () => {
    ...
    const loginMutation = useMutation({
        ...
        onSuccess: (data) => {
            // This API returns the user's fields flat alongside the token,
                    ...
                    <CardContent className="space-y-4 pt-0">
                        ...
                        <div className='py-4'>
                            <Button type="submit" className={"w-full cursor-pointer"} disabled={loginMutation.isPending}>
                                {loginMutation.isPending ? (<span className='flex items-center gap-2'><LoaderCircle className='h-4 w-4 animate-spin' /> Logging in... </span>) : ("Login")}
                            </Button>
                        </div>
                    </CardContent>
